...
class PostBillHeader extends Component {
    constructor(props){
        super(props);
        this.state={
            active:'#f0f0f0',
    ...
    render() {
        return (
            ...
            <TouchableOpacity style={{marginTop:heightPercentageToDP('2.15%'),marginLeft:widthPercentageToDP('2.85%')}} onPress={this.nav.bind()} >
             ...
             <AtiText style={{marginTop:heightPercentageToDP('2.5%'),marginLeft:widthPercentageToDP('29%')}}>Postpaid Bill</AtiText>
...
export default connect(mapStateToProps, mapActionToProps())(withWebConsole(PostBillHeader));