    ...
    render() {
        return (
            ...
            <TouchableOpacity style={{marginTop:heightPercentageToDP('2.15%'),marginLeft:widthPercentageToDP('2.85%')}} onPress={this.nav.bind()} >
             ...
             <AtiText style={{marginTop:heightPercentageToDP('2.5%'),marginLeft:widthPercentageToDP('35%')}}>Transfer</AtiText>
...
export default connect(mapStateToProps, mapActionToProps())(withWebConsole(TransferHeader));