    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <AtiText style={{marginTop:heightPercentageToDP('2.5%'),marginLeft:widthPercentageToDP('43%')}}>Receipt</AtiText>
                <TouchableOpacity style={{marginTop:heightPercentageToDP('2.5%'),marginLeft:widthPercentageToDP('25%') }} onPress={this.cancel.bind()}>
                <AtiText>Cancel</AtiText>
                </TouchableOpacity>
            </View>
