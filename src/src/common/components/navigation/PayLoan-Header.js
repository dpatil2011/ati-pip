...
class PayLoanHeader extends Component {
    constructor(props){
        super(props);
        this.state={
            active:'#f0f0f0',
    ...
    render() {
        return (
            ...
            <TouchableOpacity style={{marginTop:heightPercentageToDP('2.15%'),marginLeft:widthPercentageToDP('2.85%')}} onPress={this.nav.bind()} >
             ...
             <AtiText style={{marginTop:heightPercentageToDP('2.5%'),marginLeft:widthPercentageToDP('28%')}}>Pay Loan</AtiText>
            
             <TouchableOpacity>
                <View style={{height:heightPercentageToDP('0.2%'),width:widthPercentageToDP('20%'), flexDirection:'row', marginLeft:widthPercentageToDP('35%')} }>
...
export default connect(mapStateToProps, mapActionToProps())(withWebConsole(PayLoanHeader));