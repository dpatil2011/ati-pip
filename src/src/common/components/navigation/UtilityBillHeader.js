...
class UtilityBillHeader extends Component {
    constructor(props){
        super(props);
        this.state={
            active:'#f0f0f0',
    ...
    render() {
        return (
            ...
            <TouchableOpacity style={{marginTop:heightPercentageToDP('2.15%'),marginLeft:widthPercentageToDP('2.85%')}} onPress={this.nav.bind()} >
             ...
             <AtiText style={{marginTop:heightPercentageToDP('3%'),marginLeft:widthPercentageToDP('32%')}}>Utility Bill</AtiText>
             ...
             >
                <View style={{height:heightPercentageToDP('0.8%'),width:widthPercentageToDP('20%'), flexDirection:'row', marginLeft:widthPercentageToDP('28%')} }>
               {/* <Image style={styles.stretch}
                source={require('./../../../../assets/img/icon/transfer.png')} /> */}
                <Image style={styles.stretch} source={require('./../../../../assets/img/icon/transfer1.png')}/> 
...
export default connect(mapStateToProps, mapActionToProps())(withWebConsole(UtilityBillHeader));