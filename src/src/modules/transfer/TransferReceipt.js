...
class TransferReceipt extends Component {
    ...
    render() {
        return (
            ...
            <View style={{
                ...
                <Image source={receipt} style={{ width: wp('15%'), height: ('10.5%'), alignSelf: "center", marginTop: hp('1%') }} />
                <AtiText style={{
                    width: wp('45.9'),
                    height: hp('2.7%'),
                    letterSpacing: 0,
...
const mapActionToProps = () => ({
  ...
  export default connect(null, mapActionToProps())(withWebConsole(TransferReceipt));
