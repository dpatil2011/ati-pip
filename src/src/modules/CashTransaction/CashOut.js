    ...
    render() { 
        ...
        return ( 
            <View style={{backgroundColor:'#ffffff', height:hp('100%'), paddingHorizontal:wp('6.9%')}}>
                <AtiText style={{alignSelf:'center', marginTop:hp('4%'), marginBottom:hp('2%'), fontFamily: "AvenirNextLTPro", fontSize: 14, fontWeight: "normal", fontStyle: "normal", letterSpacing: 0.28, textAlign: "center", color: "#000000"}}>Nominal Withdrawal</AtiText>
       ...
       paddingTop:hp('1.1%')}}>Rp</AtiText></View>
                  ...
                  fontSize:20,
                   paddingTop:hp('1.1%')}}
                      ...
                      <TouchableOpacity style={{width:wp('80%'), backgroundColor:"#a92930", height:hp("7.8%"), marginTop:hp('8%'), paddingTop:hp('2%'), paddingLeft:wp('36%'), marginLeft:wp('3.8%'), borderRadius:wp('8%')}} onPress={this.nav.bind(this, 'CashOutSummary')}><AtiText style={{fontFamily: "AvenirNextLTPro", fontSize: 15, fontWeight: "500", fontStyle: "normal", lineHeight: 21, letterSpacing: 0, color: "#ffffff"}}>Submit</AtiText></TouchableOpacity>
...
export default connect(mapStateToProps, mapActionToProps())(withWebConsole(CashOut));
