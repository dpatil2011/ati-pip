...
import ElectricityToken from './ElectricityToken';
class ElectricityTokenPin extends Component {
  constructor(props){
    super(props);
    this.state={
      text:'',
  ...
  changeText(newText) {
    ...
    if(newText.length==6){
     ...
     //   this.props.navigate('Receipt')
        this.props.navigate('ElectricityTokenReceipt');
...
export default connect(null,mapActionToProps())(ElectricityTokenPin)