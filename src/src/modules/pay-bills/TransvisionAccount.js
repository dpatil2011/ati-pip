...
import * as ac from './../pay-bills/store/Transvision-action';
...
class TransvisionAccount extends Component {
    constructor(props) {
        super(props);
        this.state = {
            savingsAccounts: [],
...
select = (e) => {
  ...
  this.props.navigate('Transvision');
}
...
export default connect(mapStateToProps, mapActionToProps())(withWebConsole(TransvisionAccount));
