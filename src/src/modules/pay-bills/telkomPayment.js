    ...
    render() {
        return (
            ...
            <View style={{ marginTop:hp('2%'), padding:wp('5%'), height:hp('50%')}}>
                ...
                <AtiText style={{marginBottom:heightPercentageToDP('2.6%'),marginTop:heightPercentageToDP('1.6%'),color:'green'}}>Available balance Rp 9,760,000</AtiText>
                <Loc style={styles.label} locKey="label.phoneNo" />
                <AtiTextInput textStyle={styles.input2} placeholder='08xxxxxxxxxxxx'
                type='numeric'
                keyboardType='phone-pad'/>
                
                <TouchableOpacity style={{width:wp('80%'), backgroundColor:"#a92930", height:hp("7.8%"), marginTop:hp('4%'), paddingTop:hp('2%'),  marginLeft:wp('3.8%'), borderRadius:wp('8%')}} 
...
export default connect(null, mapActionToProps())(withWebConsole(telkomPayment));
