...
import * as ac from './store/datapackage-action';
...
class MyAccount extends Component {
  ...
  select = (e) => {
    ...
    this.props.navigate('Datapackage');
  }
...
export default connect(mapStateToProps, mapActionToProps())(withWebConsole(MyAccount));
