...
class DestinationAccount extends Component {
    constructor(props) {
        super(props);
        this.state = {
            savingsAccounts: [],
        ...
        const s = (e) => {
            ...
            if (index === e) {
                index = 0;
                    ...
                    return(
                        <View 
                        style={{  backgroundColor: '#f8f6f0', marginLeft: wp('5.1%'), marginRight: wp('5.1%'), marginTop: hp('3%'), borderRadius: 10,
  ...
  marginTop: hp('4.2%'),
                ...
                >Note: Anda dapat mengatur dan merubah rekening tujuan akun virtual kembali sesuai kebutuhan Anda.
                </AtiText>
                <AtiButton
                onPress={this.navi}
                        buttonStyle={{
...
export default connect(mapStateToProps, mapActionToProps())(withWebConsole(DestinationAccount));