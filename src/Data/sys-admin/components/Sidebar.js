...
class Sidebar extends React.Component {
  ...
  componentDidMount() {
    ...
    var id = sessionStorage.getItem('SysId');
    if(id==null){
      window.location = '/';
    }
    // when component mounted, start a GET request
    // to specified URL
    fetch("http://192.168.0.51:5555/login/"+id)
    ...
    <div className="app-sidebar__user"><img class="app-sidebar__user-avatar" height="48px" width="48px" src={require('../../../../common/pp/pp.png')} alt="User Image"/>
      ...
      <AtiSideMenu style={{background:'#222d32'}} defaultOpenKeys={[]}
        ...
        },
        {
          "key": "re-set",
          "type": "item",
          "childComponent": <a href="/sys-admin/reset" style={{textDecoration: 'none'}}><span >    <b> <Icon type='setting' />     <span  >       Reset Password     </span></b>   </span></a>
        }
