...
class ViewPending extends Component {
    ...
    componentDidMount() {
        ...
        fetch("http://192.168.0.151:5555/users/" + userId)
        ...
        // to specified URL
        fetch("http://192.168.0.151:5555/faq/" + reqId)
            // when we get a response map the body to json
            .then(response => response.json())
            // and update the state data to said json
    ...
    onSubmit = () => {
        ...
        if (this.state.value === 1) {
            ...
            fetch("http://192.168.0.51:5555/faq/" + id, {
            ...
            var url = "http://192.168.0.51:5555/Faq_predefined";
           fetch(url, {
