...
class RequestIt extends React.Component {
  constructor(props){
    super(props);
  ...
  componentDidMount() {
    ...
    // to specified URL
    fetch("http://192.168.0.51:5555/category")
  ...
  var rand = Math.floor(Math.random() * 100000) + 1 ;
    ...
    if(request!=''&& project!=''&& asset!=''&& type!=''&& qty!=''){
      ...
      axios({       
        method: 'post',
        url: 'http://192.168.0.51:5555/request/',
        ...
        <div className="tile">
              <div className="tile-body col-md-8 offset-md-2">
                ...
                ></AtiSelectBox> */}
                  ...
                  <div className="form-group col-md-6">
                  <select className="form-control" name="type" id="ITTT">
