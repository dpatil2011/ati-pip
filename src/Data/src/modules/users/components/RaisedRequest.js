...
class RaisedRequestComp extends React.Component {
    constructor(props){
        super(props);
    ...
    componentDidMount() {
        ...
        fetch("http://localhost:5555/request?request_to=Facility&request_to=IT&user_id="+id)
                          ...
                          <AtiButton type="button" 
                            ...
                            events={
                                {onClick:()=>{
                                  ...
                                  axios({
                                    method: 'DELETE',
                                    url: 'http://localhost:5555/request/'+id,
...
}export default RaisedRequestComp
