...
{!this.state.add && 
  ...
  const next=()=>{
    var gender,fname,lname,dob,b_place,p_email,p_no,nation,religion,bloodgroup,f_name,f_dob,f_adhar,m_name,m_dob,m_adhar,bs1_name,bs1_dob,bs1_adhar,bs2_name,bs2_dob,bs2_adhar,bs3_name,bs3_dob,bs3_adhar,marital_status,dom,spouce_name,spouce_adhar,c_address,c_pcode,c_city,p_address,p_pcode,p_city='';
    sessionStorage.setItem('step',1);
    // password=Math.floor(Math.random()*100000)+1;
    // password = btoa(password)
     ...
     p_no=$('#number').val();
     nation=sessionStorage.getItem('nat');
     ...
     f_name=$('#faname').val();
      ...
      p_city=$('#pcity').val();
//'1','2','3','4'
    var data={gender,fname,lname,dob,b_place,p_email,p_no,nation,religion,bloodgroup,f_name,f_dob,f_adhar,m_name,m_dob,m_adhar,bs1_name,bs1_dob,bs1_adhar,bs2_name,bs2_dob,bs2_adhar,bs3_name,bs3_dob,bs3_adhar,marital_status,dom,spouce_name,spouce_adhar,c_address,c_pcode,c_city,p_address,p_pcode,p_city};
    axios({
        method: 'post',
